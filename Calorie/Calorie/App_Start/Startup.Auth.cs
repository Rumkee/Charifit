...
namespace Calorie
{
    ...
    var facebookAuthenticationOptions = new FacebookAuthenticationOptions() {
        AppId = ConfigurationManager.AppSettings["FacebookAppID"],///Properties.Settings.Default.FacebookAppID,
        AppSecret = ConfigurationManager.AppSettings["FacebookAppSecret"], //Properties.Settings.Default.FacebookAppSecret,

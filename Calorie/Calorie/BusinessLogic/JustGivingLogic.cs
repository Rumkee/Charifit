...
namespace Calorie.BusinessLogic
{
    public class JustGivingLogic
    {
        ...
        public static Models.Charities.Charity getOrCreateCharityRecordFromJustGivingCharityID(string JustGivingID)
        {
            ...
            var resultJSON = System.Web.Helpers.Json.Decode(result);

            var newCharity = new Models.Charities.Charity();
            newCharity.JustGivingCharityBlob = result;
            newCharity.JustGivingCharityID = JustGivingID;
            newCharity.JustGivingCharityImageURL = resultJSON.logoAbsoluteUrl;
            newCharity.JustGivingRegistrationNumber = resultJSON.registrationNumber;
            newCharity.Name = resultJSON.name;
            newCharity.CharityURL = resultJSON.websiteUrl;
            newCharity.Description = resultJSON.description;
        ...
        public static List<Models.Charities.Charity> SearchCharities(string SearchTerm)
        {
            ...
            var CharList = new List<Models.Charities.Charity>();
            //result.charityId,result.logoUrl,result.name,result.description,result.websiteUrl
            foreach(var result in System.Web.Helpers.Json.Decode(response.Content).charitySearchResults)
            {
                CharList.Add(new Models.Charities.Charity() { JustGivingRegistrationNumber=result.registrationNumber, CharityURL = result.websiteUrl, JustGivingCharityID = result.charityId, Name = result.name, Description = result.description, JustGivingCharityImageURL = result.logoUrl });
            }
        ...
        public static string GetPaymentURL(Models.Pledges.PledgeContributors contrib, UrlHelper Url, HttpRequestBase Request)
        {
